  ...
  return userData && (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
          ...
          <input
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]'>
                    ...
                    {isEdit && userData.address 
                        ? <p>
              <input className='bg-gray-50' type="text"
                onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, street: e.target.value } }))}
            ...
            : <p className='text-gray-500'>
              {userData.address?.street} <br /> {userData.address?.city}</p>
                    }
          ...
          ? <button
            ...
            className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>Save information</button>
          : <button
            onClick={() => setIsEdit(true)} className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>Edit</button>
                }
